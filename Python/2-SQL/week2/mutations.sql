...
-- A: Introduce a new table called employees_categories with 2 columns employeed_id and category_id. These 2 columns together will form a primary key for this table. 
-- Q: What type of relationship is this? (e.g. 1-1, 1-many, or many-to-many?)
-- A: This is Many to Many relationship. That is the reason we have introduced the bridging table called employees_categories.
